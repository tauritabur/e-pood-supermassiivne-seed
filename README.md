...
4. Käivita seemneskript: `bun run seed.js`
5. Kontrolli row-countid: customers: 2M+, products: 120k+, orders: 2.2M+, order_items: 8M+
...
- Proportsioonide aluseks loogika: orders ja customers on põhikoormus, products piisavalt et igal orderil oleks valikut, order_items kõige massiivsem
...
## Repo nimi
- „e-pood-supermassiivne-seed” – iseloomustab projekti sisu
